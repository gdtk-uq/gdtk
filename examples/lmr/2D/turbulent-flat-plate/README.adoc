...
Of note is that the reduction is super-linear, a result of the second order numerical method used to comput the viscous fluxes. The order of convergence (p) shows the exponent in this relationship between refinement and error.
[stem]
++++
