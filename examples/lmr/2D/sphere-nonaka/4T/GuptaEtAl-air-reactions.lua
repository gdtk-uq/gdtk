-- GuptaEtAl-air-2T.lua
-- Derived from the single-temperature file GuptaEtAl-air-reactions.lua
...
Reaction{
   'O2 + M <=> O + O + M',
   fr={'Park', A=3.610e+18, n=-1.00, C=59400.00, s=s, mode="O2"},
...
Reaction{
   'N2 + M <=> N + N + M',
   fr={'Park', A=1.920e+17, n=-0.50, C=113100.00, s=s, mode="N2"},
...
Reaction{
   'N2 + N <=> N + N + N',
   fr={'Park', A=4.150e+22, n=-1.50, C=113100.00, s=s, mode="N2"},
...
Reaction{
   'NO + M <=> N + O + M',
   fr={'Park', A=3.970e+20, n=-1.50, C=75600.00, s=s, mode="NO"},
