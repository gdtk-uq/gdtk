--
-- Supersonic Flow Over a Ramp at Mach 2.0 taken from ref. [1].
--
-- references:
-- [1] Comparison of Matrix-free Acceleration Techniques in Compressible Navier-Stokes Calculations,
--     N. P. C. Marques and J. C. F. Pereira,
...
-- define free stream condition taken from ref. [1].
M_inf  = 2.0
gs.rho = 1.0     -- kg/m^3
gs.T   = 300.0   -- K
...
for i=0,nblocks-1 do
   fileName = string.format(grid_location.."block_%d_ramp.su2", i)
