...
driver_patch = CoonsPatch:new{p00={x=0,  y=0}, p10={x=L1, y=0},
                              p11={x=L1, y=H}, p01={x=0,  y=H}}
-- Gas region that is compressed by piston.
driven_patch = CoonsPatch:new{p00={x=L2, y=0}, p10={x=L3, y=0},
                              p11={x=L3, y=H}, p01={x=L2, y=H}}
nxc = 100; nyc = 2
