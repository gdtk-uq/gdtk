# classic-shock-tube.py
#
# Run with commands like:
# $ prep-gas ideal-air.inp ideal-air.gas
# $ python3 classic-shock-tube.py
#
# PJ, 2020-02-10 adapted from the Lua script
#     2024-01-17 gas model file name adjusted and pressure ratio to 100
...
# at t=500us, where the diaphragm is at x=0.5.
x_centre = 0.5 # metres
t = 500.0e-6 # seconds
