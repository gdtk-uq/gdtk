# prepare-static-profile.py
#
# Run with commands like:
# $ prep-gas ideal-air.inp ideal-air.gas
# $ python3 prepare-static-profile.py
#
# PJ, 2024-01-17 adapted from classic-shock-tube.py
...
x = 0.5
ys = [0.025, 0.075]
f = open('static-profile.data', 'w')
f.write('# pos.x pos.y p T vel.x vel.y\n')
for y in ys:
