print("Sod's Classic Shock tube, just the driven tube, InFlowBC_Transient")
-- Adapted from InFlowBC_TransientProfile example, PJ 2025-01-27
--
...
profile = InFlowBC_Transient:new{fileName="transient-inflow.data"}
--
