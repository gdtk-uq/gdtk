-- job.lua for simple shock tube to test timing of waves.
...
--
print("One-dimensional shock tube with air driving air.")
...
registerFluidGrid{
   grid=StructuredGrid:new{pvolume=pvol, niv=101, njv=3, nkv=3},
   fsTag="initial"
}
