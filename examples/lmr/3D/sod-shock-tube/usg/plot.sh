...
plot "sod_new.dat" using 1:5 title "lmr (usg)" with points ps 1 pt 1, \
...
set xrange [0.0:1.0]
set yrange [0.0:1.2]
plot "sod_new.dat" using 1:4 title "lmr (usg)" with points ps 1 pt 1, \
...
plot "sod_new.dat" using 1:7 title "lmr (usg)" with points ps 1 pt 1, \
...
set xrange [0.0:1.0]
set yrange [0.0:500.0]
plot "sod_new.dat" using 1:6 title "lmr (usg)" with points ps 1 pt 1, \
