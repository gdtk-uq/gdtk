...
plot "sod_new.dat" using "pos.x":"p" title "lmr (usg)" with points ps 1 pt 1, \
...
set xrange [0.0:1.0]
set yrange [0.0:1.2]
plot "sod_new.dat" using "pos.x":"rho" title "lmr (usg)" with points ps 1 pt 1, \
...
plot "sod_new.dat" using "pos.x":"vel.x" title "lmr (usg)" with points ps 1 pt 1, \
...
set xrange [0.0:1.0]
set yrange [0.0:500.0]
plot "sod_new.dat" using "pos.x":"T" title "lmr (usg)" with points ps 1 pt 1, \
