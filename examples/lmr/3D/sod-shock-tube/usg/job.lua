-- job.lua for simple shock tube to test timing of waves, unstructured grid.
...
--     03-Mar-2024 ported to Eilmer 5
--
print("One-dimensional shock tube with air driving air (USG).")
...
sg = StructuredGrid:new{pvolume=pvol, niv=101, njv=3, nkv=3}
registerFluidGrid{
   grid=UnstructuredGrid:new{sgrid=sg},
   fsTag="initial"
}
