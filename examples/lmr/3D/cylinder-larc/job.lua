--
-- 5-species air thermochemical nonequilibrium flow over a cylinder.
--
-- Details (including cylinder.g grid file) are taken from the LARC hypersonic benchmark test cases website:
-- https://fun3d.larc.nasa.gov/chapter-2.html#hypersonic_benchmarks
--
-- @author: Kyle A. Damm (2024-09-13)
--
...
-- ==========================================================
nsp, nmodes, gm = setGasModel('air-5sp-2T.gas')
gs = GasState:new{gm}
...
flowDict            = {}
inflow              = FlowState:new{p=gs.p, T=gs.T, T_modes=gs.T_modes, velz=-V_inf, massf=gs.massf}
...
for i=0,nblocks-1 do
   fileName = string.format(grid_location.."block_%d_cylinder.su2", i)
