...
# This l1d4 input script built by PJ, 2020-07-16, to match
# the 2019-03-21 L1d3 simulations by Wilson and Ryan.
config.title = "T4 Tunnel Simulation for run 11316, argon driver"
#
gm_ideal_air = add_gas_model('ideal-air-gas-model.lua')
gm_ideal_argon = add_gas_model('ideal-argon-gas-model.lua')
...
add_loss_region(26.10, 36.06, 1.5)   # shock tube losses
...
compressed_air = GasSlug(p=1.750e6, vel=0.0, T=296.0, gmodel_id=gm_ideal_air,
                         ncells=500, to_end_L=False, to_end_R=True, cluster_strength=1.2,
                         viscous_effects=1)
driver_gas = GasSlug(p=27.4e3, vel=0.0, T=296.0, gmodel_id=gm_ideal_argon,
...
#
config.max_time = 340.0e-3 # the simulation will stop at this time
