# co2_scheme_validation.py
#
# Post-shock-relaxation calculation using the general gas model.
#
# PJ, 2019-12-17, Ported from the equivalent Lua script.
# JK, 2020-01-30, Changed script to validate CO2 reaction scheme
#                 against 1D case in Park et al. (1994)
#
...
state1.massf = {"CO2":0.9664, "N2":0.0174, "Ar":0.0147, "O2":0.001, "CO":0.0005}
...
output_filename = "mars-atm-v_{:.2f}.data".format(v1/1000)
...
t_inc = 1e-8 # User-selected time steps, s
