...
-- Date: 2021-06-12
-- Modified for 1T calculations, Peter J., 2025-02-12
--
-- Reference:
...
Reaction{
   'CO2 + M <=> CO + O + M',
   fr={'Arrhenius', A=2.88e11,  n=0.5,  C=74.8/R_univ},
   label='r1'
}

Reaction{
   'CO + M <=> C + O + M',
   fr={'Arrhenius', A=8.79e29, n=-3.52, C=255.76/R_univ},
...
Reaction{
   'CO + CO <=> C + O + CO',
   fr={'Arrhenius', A=1.76e30, n=-3.52, C=255.76/R_univ},
   label='r3'
}

Reaction{
   'CO + O <=> C + O + O',
   fr={'Arrhenius', A=1.29e31, n=-3.52, C=255.76/R_univ},
   label='r4'
}

Reaction{
   'O2 + M <=> 2O + M',
   fr={'Arrhenius', A=2.55e18, n=-1.0, C=118.7/R_univ},
...
Reaction{
   'O2 + O2 <=> 2O + O2',
   fr={'Arrhenius', A=2.75e19, n=-1.0, C=118.7/R_univ},
   label='r6'
}

Reaction{
   'O2 + O <=> 3O',
   fr={'Arrhenius', A=2.1e18, n=-1.0, C=117.96/R_univ},
   label='r7'
}
