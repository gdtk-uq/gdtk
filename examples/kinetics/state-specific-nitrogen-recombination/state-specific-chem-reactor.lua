...
gm = GasModel:new{"pseudo-species-nitrogen-2sp.lua"}
...
f:write('# 1:t(s)  2:T(K)  3:p(Pa)  4:mf_N_e2p3Minus4S  5:mf_N2_eX1SIGGPlus_v0\n')
f:write(string.format("%10.3e %10.3f %10.3e %20.12e %20.12e \n",
                      t, Q.T, Q.p, Q.massf.N_e2p3Minus4S, Q.massf.N2_eX1SIGGPlus_v0))
while t <= tFinal do
