"""
x2_zander_condition_air_theory_scripting_example_with_custom_driver.py

This is the same as the x2_zander_condition_air_theory_scripting_example
except here I have added the functionality to specify the driver condition
as a dictionary in the config dict.

$ python3 x2_zander_condition_air_theory_scripting_example_with_custom_driver.py

Chris James (c.james4@uq.edu.au) - 09/02/23
...
driver_dict = {'driver_condition_name' : 'x2-lwp-2.0mm-0', 'driver_condition_type' : 'empirical',
               ...
               'p4' : 23.9e6, 'T4' : 2747.0, 'M_throat' : 1.0}

config_dict = {'mode':'fully_theoretical','output_filename':'x2_zander_condition_air_theory',
               'facility':'x2_nozzle', 'driver_condition':'custom_from_dict', 'driver_dict':driver_dict,
