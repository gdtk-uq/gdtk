...
plt.add_text("VinokurFunction:new{n=15, s1=0.01, sn=0.02}", position=(155,170), font='courier', color="black", font_size=18)
...
plt.add_text("VinokurFunction:new{n=15, s1=0.005, sn=0.02}", position=(155,170), font='courier', color="black", font_size=18)
plt.add_text("0", position=(295,80), font_size=14, font='courier')
plt.add_text("1", position=(1690,80), font_size=14, font='courier')
plt.view_xy()
plt.camera.zoom(5.5)
...
plt.add_text("VinokurFunction:new{n=15, s1=0.005, sn=0.03}", position=(155,170), font='courier', color="black", font_size=18)
plt.add_text("0", position=(295,80), font_size=14, font='courier')
plt.add_text("1", position=(1690,80), font_size=14, font='courier')
plt.view_xy()
plt.camera.zoom(5.5)
