...
plt.add_text("VinokurGeomHybridFunction:new{n=15, s1=0.01, n1=3, r1=1.1, sn=0.02, nn=5, rn=1.1}", position=(155,170), font='courier', color="black", font_size=18)
...
plt.subplot(1, 0)
plt.add_mesh(vin0, line_width=4, color="black", point_size=12,  show_vertices=True, render_points_as_spheres=True)
plt.add_text("VinokurGeomHybridFunction:new{n=15, s1=0.01, n1=10, r1=1.3, sn=0.02, nn=5, rn=1.05}", position=(155,170), font='courier', color="black", font_size=18)
plt.add_text("0", position=(295,80), font_size=14, font='courier')
plt.add_text("1", position=(1690,80), font_size=14, font='courier')
plt.view_xy()
plt.camera.zoom(5.5)
...
plt.add_text("VinokurGeomHybridFunction:new{n=15, s1=0.03, n1=5, r1=1.3, sn=0.03, nn=5, rn=1.05}", position=(155,170), font='courier', color="black", font_size=18)
plt.add_text("0", position=(295,80), font_size=14, font='courier')
plt.add_text("1", position=(1690,80), font_size=14, font='courier')
plt.view_xy()
plt.camera.zoom(5.5)
