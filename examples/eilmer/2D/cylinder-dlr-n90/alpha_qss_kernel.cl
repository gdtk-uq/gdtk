...
void ydot(__global double *Y,                              
           ...
           idx, int numcell)                               
{            
q[idx+numcell*0]=+kb[idx+numcell*0]*1.0*Y[idx+numcell*0]*Y[idx+numcell*1]*Y[idx+numcell*1]+kb[idx+numcell*1]*1.0*Y[idx+numcell*1]*Y[idx+numcell*1]*Y[idx+numcell*1];
q[idx+numcell*1]=+kf[idx+numcell*0]*2.0*Y[idx+numcell*0]*Y[idx+numcell*0]+kf[idx+numcell*1]*2.0*Y[idx+numcell*0]*Y[idx+numcell*1];
p[idx+numcell*0]=+kf[idx+numcell*0]*1.0*Y[idx+numcell*0]+kf[idx+numcell*1]*1.0*Y[idx+numcell*1];
p[idx+numcell*1]=+kb[idx+numcell*0]*2.0*Y[idx+numcell*0]*Y[idx+numcell*1]+kb[idx+numcell*1]*2.0*Y[idx+numcell*1]*Y[idx+numcell*1];
