...
cp ${DGD_REPO}/examples/kinetics/nitrogen-dissociation-2T/KewleyHornung-nitrogen-dissociation-2T.lua .
...
prep-chem nitrogen-gas-model.lua KewleyHornung-nitrogen-dissociation-2T.lua N2-diss-2T.chem
