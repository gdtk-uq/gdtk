...
e4shared --post --job=cyl50 --tindx-plot=last  --vtk-xml --add-vars="mach,pitot,total-p,total-h"

# Extract the profile near the downstream end of the cylinder.
e4shared --post --job=cyl50 --tindx-plot=last --extract-line="0.917,0.0,0,0.917,0.025,0,1000" --output-file=profile-i23.data
