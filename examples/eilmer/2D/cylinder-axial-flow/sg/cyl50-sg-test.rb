#! /usr/bin/env ruby
# cyl50-usg-test.rb
# This is a viscous boundary layer case with a structured-grid.
# PJ, 2019-11-14
#
require 'test/unit'
require 'open3'

class TestCyl50_SG < Test::Unit::TestCase
  def test_0_prep
  ...
  def test_1_run
    ...
    assert((steps - 186645).abs < 300, "Failed to take correct number of steps.")
  end
