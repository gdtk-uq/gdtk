...
image::nonaka-temperature-contours.png[width=100%,caption="Temperature fields in the shock layer in front of a sphere fired in air."]
...
image::nonaka-2T-model-shock-shape.png[width=100%,caption="Comparison of Eilmer solution to experimental measurement of shock shape."]
