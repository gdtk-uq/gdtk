...
--
config.title = "Truncated Busemann inlet with "..
   "M_inf=7.12, M_2=3.00, M_3=2.27, and theta_s=17.2deg"
config.dimensions = 2
...
pts = {
   ...
   {x=3.926667, y=0.881750},
   {x=4.452401, y=0.826332},
   {x=4.906329, y=0.823080},
   {x=5.265781, y=0.674828},
   {x=5.726706, y=0.744892},
   {x=6.159554, y=0.508068},
   {x=6.525648, y=0.505361},
   {x=6.973466, y=0.287438},
   {x=7.488979, y=0.146429}
}
