...
-- PAJ 2021-08-01 Source-flow options and write loads files.
--
...
blk = FBArray:new{
   grid=grid, initialState=initial, label='blk',
   bcList={
      west=InFlowBC_ShockFitting:new{flowState=inflow, x0=-0.1066, r=0.1},
      east=WallBC_NoSlip_FixedT:new{Twall=296.0, group="loads"},
