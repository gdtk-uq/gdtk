...
R = 0.008 -- m
nxc = 60; nyc = 60; factor = 2
-- quadant above x-axis
bp = billig_patch.make_patch{Minf=M1, R=R, xc=R, scale=2.0, quadrant=2}
...
bp = billig_patch.make_patch{Minf=M1, R=R, xc=R, scale=2.0, quadrant=3}
...
inflow_bc = InOutFlowBC_DualState:new{flowState1=fs1, flowState2=fs2,
                                      p={x=-0.010,y=-0.004286},
                                      n={x=-math.sin(beta),y=math.cos(beta)}}
--]]
-- No oblique shock
inflow_bc = InFlowBC_Supersonic:new{flowState=fs1}
...
--
config.max_time = 300.0e-6  -- seconds
