...
--                 2020-06-11 use ceq equilibrium updater (NNG)
...
nsp, nmodes, gm = setGasModel('air-eq.lua')
...
-- The equilibrium updater just needs the gas file
config.reactions_file = 'air-eq.lua'
