...
-- config.reaction_time_delay = 0.6*config.max_time
...
westBC = InFlowBC_Transient:new{filename='inflow.data'}
-- westBC = InFlowBC_Supersonic:new{flowState=initial}
blk = FluidBlockArray{grid=grd, initialState=initial, label='blk',
		      bcList={west=westBC, north=OutFlowBC_Simple:new{}},
		      nib=1, njb=4}
