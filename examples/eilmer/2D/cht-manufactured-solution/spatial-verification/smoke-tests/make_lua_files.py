...
# Energy equation in solid domain
...
if __name__ == '__main__':
    taskList = [ {'fName': "udf-source-terms.lua", 'tName': "udf-source-template.lua",
                 ...
                 {'fName': "ref-soln.lua", 'tName': "ref-soln-template.lua",
                  'varList': [("tab.rho", rho), ("tab.p", p), ("tab.T", T), ("tab['vel.x']", u), ("tab['vel.y']", v)]},
                 {'fName': "ref-solid-soln.lua", 'tName': "ref-solid-soln-template.lua",
                  'varList': [("tab.T", T_s)]},
                 {'fName': "fill-fn.lua", 'tName': "fill-fn-template.lua",
                  'varList': [("p", p), ("T", T), ("velx", u), ("vely", v)]},
                 {'fName': "udf-solid-source-terms.lua", 'tName': "udf-solid-source-template.lua",
                  'varList': [("fe_s", fe_s)]},
                 {'fName': "udf-solid-bc.lua", 'tName': "udf-solid-bc-template.lua",
                  'varList': [("T_s", T_s)]},
                 {'fName': "fill-solid-fn.lua", 'tName': "fill-solid-fn-template.lua",
                  'varList': [("T_s", T_s)]} ]
