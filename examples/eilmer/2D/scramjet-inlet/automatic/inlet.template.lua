...
L1 = 0.30
L2 = 0.20
h0 = $H0 -- to adjust height of duct (0.05)
h1 = $H1 -- to adjust height of B1 on ramp (0.05)
h2 = $H2 -- to adjust height of B2 on ramp (0.15)
h3 = 0.30
theta = math.rad($THETA) -- to adjust dip of cowl (10.0)
r = 0.15
Htop = 1.5
pnts = {
