...
image::odw-colourmaps.png[width=100%,caption="Left: Pressure colourmap of oblique detonation wave with shocked cells highlighted. Right: Product mass fraction colourmap showing linear fit to shocked cells."]
