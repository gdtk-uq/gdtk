...
image::catalytic-wall-N2-field.png[width=100%,caption="Molecular Nitrogen Mass Fraction for catalytic wall vs. noncatalytic wall at 2200K."]
...
image::catalytic-wall-heat-transfer.png[width=100%,caption="Comparison of heat transfer due to wall chemistry effects."]
