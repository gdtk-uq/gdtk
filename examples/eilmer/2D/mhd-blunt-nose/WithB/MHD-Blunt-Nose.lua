...
function Static(x, y, z)
	 ...
	 --Location of wires used to imitate magnetic field- vary theta to change orientation of magnet
	 theta = 0
	 wire1x = 1e-6*math.cos(theta)
	 wire1y = 1e-6*math.sin(theta)
	 wire2x = -1e-6*math.cos(theta)
	 wire2y = -1e-6*math.sin(theta)

	 --Current in wires (scale until resultant magnetic field is at desired magnitude)
	 mu_0 = 1.2566e-6
	 I = 719.3e6 * mu_0	--scale by magnetic permeability
