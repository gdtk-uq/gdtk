...
--
config.title = "Mabey Mach 4.5 flow over a flat plate (k-omega) with wall function"
print(config.title)
config.dimensions = 2
--
...
-- config.cfl_schedule_values = {0.4, 0.6, 0.6}
-- config.cfl_schedule_times = {0.0, 20.0e-6, 40.0e-6}
--
...
cflist = {north=cfx, east=RobertsFunction:new{end0=false,end1=true,beta=1.014},
	  south=cfx, west=RobertsFunction:new{end0=false,end1=true,beta=1.074}}
...
blks = FBArray:new{grid=grd, nib=2, njb=2, fillCondition=inflow,
                   bcList={north=WallBC_NoSlip_Adiabatic:new{wall_function=true, group="wall"},
