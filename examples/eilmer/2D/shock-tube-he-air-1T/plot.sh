...
#
e4shared --post --job=he-air-1T --tindx-plot=140 \
         --slice-list=":,:,0,0" --output-file="slice-tindx-140-cells.data"
...
plot "slice-tindx-140-cells.data" using 1:(\$9/1000) title "Eilmer4" with points ps 1 pt 1, \
...
set xrange [-2.0:9.0]
set yrange [0.0:0.2]
plot "slice-tindx-140-cells.data" using 1:5 title "Eilmer4" with points ps 1 pt 1, \
...
set xrange [-2.0:9.0]
set yrange [0.0:4.0]
plot "slice-tindx-140-cells.data" using 1:(\$6/1000) title "Eilmer4" with points ps 1 pt 1, \
...
plot "slice-tindx-140-cells.data" using 1:24 title "Eilmer4" with points ps 1 pt 1, \
