...
class TestMMS_Temporal < Test::Unit::TestCase
  ...
  def test_1_run
    cmd = "e4-nk-shared --job=temporal-mms"
    o, e, s = Open3.capture3(*cmd.split)
    assert_equal(s.success?, true)
    steps = 0
    lines = o.split("\n")
    ...
    assert((steps - 100).abs < 10, "Failed to take correct number of steps.")
  end
  ...
  def test_2_check_norms
    ...
    lines = o.split("\n")
    names = ['L1', 'L2', 'Linf']
    refs = {'L1'=>3.730430151094309176e-05, 'L2'=>4.457255703884277932e-05, 'Linf'=>8.143632496793173914e-05}
