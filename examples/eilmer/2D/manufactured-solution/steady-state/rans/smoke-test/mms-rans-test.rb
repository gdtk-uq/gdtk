...
class TestMMS_RANS < Test::Unit::TestCase
  ...
  def test_1_run
    ...
    assert((steps - 18).abs < 3, "Failed to take correct number of steps.")
  end
  ...
  def test_2_check_norms
    ...
    lines = o.split("\n")
    names = ['L1', 'L2', 'Linf']
    refs = {'L1'=>2.206134561402224841e-03, 'L2'=>2.782961823711855697e-03, 'Linf'=>1.393160013536143271e-02}
