...
class TestCompCorner < Test::Unit::TestCase
  ...
  def test_2_adjoint
    ...
    assert((grad1 - -1.8644685491709595e+02).abs < 1.0e-10, "Failed to compute correct gradient for variable 1.")
    assert((grad2 - -3.6804864018006072e+00).abs < 1.0e-10, "Failed to compute correct gradient for variable 2.")
  end
