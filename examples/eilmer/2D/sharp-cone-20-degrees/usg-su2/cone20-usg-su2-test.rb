#! /usr/bin/env ruby
# cone20-usg-su2-test.rb
# Tests for the conical-flow sharp-cone example,
# unstructured-grid from su2 file.
...
class TestCone20_USG_SU2 < Test::Unit::TestCase
  def test_0_prep
  ...
  def test_1_run
    ...
    assert((steps - 1633).abs < 3, "Failed to take correct number of steps.")
  end
