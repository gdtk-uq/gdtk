...
blk0.bcList[west_face_indx] = InFlowBC_Supersonic:new{flowState=inflow, label="inflow-boundary"}
blk0.bcList[east_face_indx] = ExchangeBC_MappedCell:new{}
blk1.bcList[west_face_indx] = ExchangeBC_MappedCell:new{}
blk1.bcList[east_face_indx] = OutFlowBC_Simple:new{label="outflow-boundary"}
