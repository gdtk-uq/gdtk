...
-- 2017-02-14 -- try reading inflow profile

-- We can set individual attributes of the global data object.
config.title = "Mach 1.5 flow over a 20 degree cone -- using profile."
print(config.title)
config.dimensions = 2
...
blk0 = FluidBlock:new{grid=grid0, fillCondition=initial}
