...
-- PJ, 2015-10-20
--     2015-10-26 simple-ramp adaption with interesting stuff in x,z-plane
--
...
xshock = {}; yshock = {}
local nj = fsol:get_njc(0) -- cells across inflow width
local nk = fsol:get_nkc(0) -- cells up the inflow plane
for k = 0, nk-1 do
   for j = 0, nj-1 do
      xs = {}; ys = {}; ps = {}
      for ib = 0, nb-1 do
