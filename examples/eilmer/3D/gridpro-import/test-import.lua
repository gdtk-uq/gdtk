...
bcMap = {surface_4=WallBC_WithSlip:new{},
   	 surface_1=WallBC_NoSlip_FixedT:new{Twall=30000},
   	 surface_2=InFlowBC_Supersonic:new{flowState=inflow},
   	 surface_3=OutFlowBC_Simple:new{},
   	 surface_5=WallBC_WithSlip:new{}}
