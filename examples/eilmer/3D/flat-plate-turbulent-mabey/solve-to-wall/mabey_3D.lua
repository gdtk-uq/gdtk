...
-- 
config.title = "Mabey Mach 4.5 flow over a flat plate (k-omega) - 3D"
print(config.title)
config.dimensions = 3
...
clustery_e = RobertsFunction:new{end0=false, end1=true, beta=1.0014}
clustery_w = RobertsFunction:new{end0=false, end1=true, beta=1.0074}
