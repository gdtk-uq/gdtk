...
class TestMMS_NS < Test::Unit::TestCase
  ...
  def test_1_run
    ...
    assert((steps - 16).abs < 3, "Failed to take correct number of steps.")
  end
  ...
  def test_2_check_norms
    ...
    lines = o.split("\n")
    names = ['L1', 'L2', 'Linf']
    refs = {'L1'=>5.159066297590073156e-04, 'L2'=>6.749919928652144173e-04, 'Linf'=>2.121802446922727015e-03}
