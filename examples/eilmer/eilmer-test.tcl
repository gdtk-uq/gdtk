...
if { [auto_execok gpmetis] != "" } {
    lappend test_scripts "2D/sharp-cone-20-degrees/usg-metis/cone20-usg-metis.test"
}
...
lappend test_scripts "2D/reactor-n2/reactor.test"
...
lappend test_scripts "2D/shock-fitting/cylinder/cyl-sf.test"
lappend test_scripts "2D/oblique-detonation-wave/odw.test"
...
lappend test_scripts "2D/cylinder-giordano/two-temperature/inf_cyl.test"
lappend test_scripts "3D/simple-ramp/sg/ramp.test"
lappend test_scripts "2D/cylinder-dlr-n90/cpu-chem/n90.test"
lappend test_scripts "2D/binary-diffusion/bd.test"
# lappend test_scripts "2D/sphere-lobb/smoke-test/lobb.test"
# lappend test_scripts "2D/radiating-cylinder/Argon/MC/cyl.test"
lappend test_scripts "2D/nozzle-shock-tunnel-t4m4/t4m4.test"
if {$long_tests} {
