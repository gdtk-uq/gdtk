...
cp ${DGD_REPO}/examples/kinetics/air-chemistry-2T/air-5sp-gas-model.lua ./air-5sp-2T.inp
cp ${DGD_REPO}/examples/kinetics/air-chemistry-2T/GuptaEtAl-air-reactions-2T.lua ./GuptaEtAl-air-2T.lua
cp ${DGD_REPO}/examples/kinetics/air-chemistry-2T/air-energy-exchange.lua ./air-energy-exchange.inp
sed -i 's+11-species-air+5-species-air+g' GuptaEtAl-air-2T.lua

prep-gas air-5sp-2T.inp air-5sp-2T.lua
prep-chem air-5sp-2T.lua GuptaEtAl-air-2T.lua air-5sp-6r-2T.lua
prep-kinetics air-5sp-2T.lua air-5sp-6r-2T.lua air-energy-exchange.inp air-energy-exchange.lua
