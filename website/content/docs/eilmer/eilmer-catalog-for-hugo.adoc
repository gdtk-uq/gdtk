---
title: "Catalogue of Examples"
description: "Eilmer Catalogue of Examples"
lead: ""
draft: false
images: []
menu:
...
include::../examples/eilmer/2D/underexpanded-jet/readme.adoc[]

include::../examples/eilmer/2D/shear-layer-periodic/readme.adoc[]
