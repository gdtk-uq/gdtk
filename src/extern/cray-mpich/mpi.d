...
immutable MPI_Datatype MPI_CXX_BOOL = cast(MPI_Datatype) 0x0c000000;
immutable MPI_Datatype MPI_CXX_FLOAT_COMPLEX = cast(MPI_Datatype) 0x0c000000;
immutable MPI_Datatype MPI_CXX_DOUBLE_COMPLEX = cast(MPI_Datatype) 0x0c000000;
immutable MPI_Datatype MPI_CXX_LONG_DOUBLE_COMPLEX = cast(MPI_Datatype) 0x0c000000;
...
enum MPIX_STREAM_ISEND = 1;
enum MPIX_STREAM_IRECV = 2;
...
alias MPI_Comm_errhandler_fn = MPI_Comm_errhandler_function; // NNG Manual Edit
alias MPI_File_errhandler_fn = MPI_File_errhandler_function; // NNG Manual Edit
alias MPI_Win_errhandler_fn = MPI_Win_errhandler_function; // NNG Manual Edit
...
int MPIX_Irecv_stream (
    ...
    MPI_Request* request,
    void* stream);
int MPIX_Fence_stream (const int fence_op, void* stream);
int MPI_Accumulate (
...
int MPI_Win_create_errhandler (
    MPI_Win_errhandler_fn win_errhandler_fn,
    MPI_Errhandler* errhandler);
...
int PMPIX_Irecv_stream (
    ...
    MPI_Request* request,
    void* stream);
int PMPIX_Fence_stream (const int fence_op, void* stream);
int PMPI_Accumulate (
    const(void)* origin_addr,
    int origin_count,
    MPI_Datatype origin_datatype,
