...
unittest {
    ...
    auto p = h1(0.5);
    assert(approxEqualVectors(p, Vector3(0.5, 0.7071068, 0.7071068)));
    ...
    auto p2 = h2(0.5);
    assert(approxEqualVectors(p2, Vector3(0.5, 0.7071068, 0.7071068))); // "Helix from fundamental parameters"
}
