...
extern(C) int configSetFromTable(lua_State* L)
{
    ...
    mixin(get_bool_field("spatial_deriv_retain_lsq_work_data", "spatial_deriv_retain_lsq_work_data"));
...
extern(C) int configGet(lua_State* L)
{
    ...
    case "spatial_deriv_retain_lsq_work_data": lua_pushboolean(L, GlobalConfig.spatial_deriv_retain_lsq_work_data); break; 
