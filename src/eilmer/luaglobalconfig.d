...
extern(C) int configSetFromTable(lua_State* L)
{
    ...
    mixin(get_bool_field("suppress_reconstruction_at_xaxis", "suppress_reconstruction_at_xaxis"));
...
extern(C) int configGet(lua_State* L)
{
    ...
    case "suppress_reconstruction_at_xaxis": lua_pushboolean(L, GlobalConfig.suppress_reconstruction_at_xaxis); break;
