...
extern(C) int configSetFromTable(lua_State* L)
{
    ...
    mixin(get_int_field("residual_smoothing_iterations", "residual_smoothing_iterations"));
    mixin(get_enum_field("residual_smoothing_type", "residual_smoothing_type", "residual_smoothing_type_from_name"));
    ...
    mixin(get_bool_field("with_super_time_stepping_flexible_stages", "with_super_time_stepping_flexible_stages"));
    mixin(get_double_field("solid_domain_cfl", "solid_domain_cfl"));
    ...
    mixin(get_double_field("flowstate_limits_min_pressure", "flowstate_limits.min_pressure"));
    ...
    mixin(get_bool_field("suppress_reconstruction_at_captured_shocks", "suppress_reconstruction_at_shocks")); // old name
    ...
    mixin(get_bool_field("shock_fitting_allow_flow_reconstruction","shock_fitting_allow_flow_reconstruction"));
    ...
    mixin(get_int_field("snapshot_count", "snapshotCount"));
    mixin(get_int_field("number_total_snapshots", "nTotalSnapshots"));
...
extern(C) int configGet(lua_State* L)
{
    ...
    case "residual_smoothing_iterations": lua_pushinteger(L, GlobalConfig.residual_smoothing_iterations); break;
    case "residual_smoothing_type": lua_pushstring(L, residual_smoothing_type_name(GlobalConfig.residual_smoothing_type).toStringz); break;
    ...
    case "with_super_time_stepping_flexible_stages": lua_pushboolean(L, GlobalConfig.with_super_time_stepping_flexible_stages); break;
    case "solid_domain_cfl": lua_pushnumber(L, GlobalConfig.solid_domain_cfl); break;
    ...
    case "flowstate_limits_min_pressure": lua_pushnumber(L, GlobalConfig.flowstate_limits.min_pressure); break;
    ...
    case "shock_fitting_allow_flow_reconstruction": lua_pushboolean(L, GlobalConfig.shock_fitting_allow_flow_reconstruction); break;
    ...
    case "snapshot_count": lua_pushnumber(L, GlobalConfig.snapshotCount); break;
    case "number_total_snapshots": lua_pushnumber(L, GlobalConfig.nTotalSnapshots); break;
