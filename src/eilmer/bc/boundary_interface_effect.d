...
BoundaryInterfaceEffect make_BIE_from_json(JSONValue jsonData, int blk_id, int boundary)
{
    ...
    case "equilibrium_composition":
        ...
        break;
    case "porous_wall_interface_effect":
        ...
        newBIE = new BIE_PorousWallInterfaceEffect(blk_id, boundary, injectant_massf, kF, kD, wall_temperature, plenum_pressure, porous_plate_thickness);
        break;
    case "user_defined":
...
class BIE_PorousWallInterfaceEffect : BoundaryInterfaceEffect {
/*
...
public:
    ...
    {
        super(id, boundary, "PorousWallInterfaceEffect");
        this.kF = kF;
        this.kD = kD;
    ...
    override string toString() const
    {
        return "PorousWallInterfaceEffect(kF=" ~ to!string(kF) ~
            ", kD=" ~ to!string(kD) ~
    ...
    override void apply_for_interface_unstructured_grid(double t, int gtl, int ftl, FVInterface face)
    {
        ...
        face.fs.copy_values_from(injectant);
    }
