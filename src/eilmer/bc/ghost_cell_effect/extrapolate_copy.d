...
public:
    ...
    override void apply_structured_grid(double t, int gtl, int ftl)
    {
        ...
        if (xOrder == 0) {
            ...
            throw new Error("FIX-ME PJ 2020-11-18 Linear extrapolation not implemented.");
        }
/+
// FIX-ME PJ 2020-11-18 Need to implement linear-extrapolation, at least.
// Have just kept one example for later rework.
