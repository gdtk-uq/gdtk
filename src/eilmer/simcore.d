			...
			my_local_value = L2_residual.re;
                    ...
                    if (GlobalConfig.is_master_task) {
                        ...
                        string txt = format("%7d %10.6e %10.6e %10.6e %10.6e %10.6e %10.6e %10.6e %10.6e %10.6e\n",
                                            SimState.step, SimState.time, wall_clock_elapsed, Linf_residuals.mass.re,
...
void gasdynamic_explicit_increment_with_fixed_grid()
{
    ...
    if (GlobalConfig.do_shock_detect) {
        if ((!GlobalConfig.frozen_shock_detector) || (GlobalConfig.shock_detector_freeze_step > SimState.step)) {
