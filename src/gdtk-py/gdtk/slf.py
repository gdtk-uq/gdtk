...
from numpy import array, concatenate, frombuffer, interp, zeros
...
class Flame(object):
    ...
    def __init__(self, file):
        ...
        if check != 0:
            raise Exception("Failed to initialize slf flame object")
    ...
    def run(self):
        result = self.lib.run()
        if result != 0:
            raise Exception("Run failed for some reason.")
        return result

    def save_solution(self):
        result = self.lib.save_solution()
        if result != 0:
            raise Exception("Failed to save slf solution to disk")
        return

    def save_log(self):
        result = self.lib.save_log()
        if result != 0:
            raise Exception("Failed to save slf log file to disk")
        return

    def load_solution(self):
        result = self.lib.load_solution()
        if result != 0:
            raise Exception("Failed to load slf solution from disk")

    def back_out_scalar_dissipation(self):
        result = self.lib.back_out_scalar_dissipation()
        if result != 0:
            raise Exception("Failed to reverse engineer a scalar dissipation")
        return
    ...
    def extract_residual(self):
        ...
        if result != 0:
            raise Exception("Failed to extract a residual vector")
    ...
    def create_polynomial_fit(self):
        ...
        for isp in range(self.nsp):
            ...
            self.polyfits["massf-{}".format(sp)] = Polynomial.fit(
                self.Z, Y[:, isp], deg=4
            )
    ...
    def return_linear_interps(self, Zs):
        ...
        Y1 = self.Y1
        Y = concatenate(
            [self.Y0.reshape((1, self.nsp)), self.Y, self.Y1.reshape((1, self.nsp))]
        )
        Z = array([0.0] + list(self.Z) + [1.0])
        T = array([self.T0] + list(self.T) + [self.T1])

        for isp in range(self.nsp):
            sp = self.species_names[isp]
            key = "massf-{}".format(sp)
            interps[key] = interp(Zs, Z, Y[:, isp], left=Y0[isp], right=Y1[isp])
        interps["T"] = interp(Zs, Z, T, left=self.T0, right=self.T1)
    ...
    def Z(self):
        ...
        if code != 0:
            raise Exception("Failed to get array Z from slf")
        return Z
    ...
    def chi(self):
        ...
        if code != 0:
            raise Exception("Failed to get array chi from slf")
        return chi
    ...
    def chi(self, arr):
        ...
        if code != 0:
            raise Exception("Failed to set array chi from slf")
        return
    ...
    def Y0(self):
        ...
        if code != 0:
            raise Exception("Failed to get array Y0 from slf")
        return Y0
    ...
    def Y1(self):
        ...
        if code != 0:
            raise Exception("Failed to get array Y1 from slf")
        return Y1
    ...
    def U0(self):
        ...
        if code != 0:
            raise Exception("Failed to get array U0 from slf")
        return U0
    ...
    def U1(self):
        ...
        if code != 0:
            raise Exception("Failed to get array U1 from slf")
        return U1
    ...
    def U(self):
        ...
        if code != 0:
            raise Exception("Failed to get array U from slf")
    ...
    def U(self, arr):
        ...
        if code != 0:
            raise Exception("Failed to set array U in slf")
        return
    ...
    def R(self):
        ...
        if code != 0:
            raise Exception("Failed to get array R from slf")
        return R
    ...
    def T(self):
        ...
        if code != 0:
            raise Exception("Failed to get array T from slf")
        return T
    ...
    def Y(self):
        ...
        if code != 0:
            raise Exception("Failed to get array Y from slf")
