...
- table.load(sfile) : function to load the table stored in string sfile.
    ...
    Usage: DATA,err = table.load("NAME.lua")

- print_var(X) : function to print content that is stored in the variable X.
    Usage: print_var(_G) - displays the content of the global namespace
