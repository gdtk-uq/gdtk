-- cea-titan-with-ions-gas-model.lua
-- Titan with ions CEA backed gas model
--
...
-- along with 'Ar', 'Ar+', and a bunch of species which came up in various states during
...
-- I also couldn't fit the final three trace species ('C2H2,acetylene', 'C4H2,butadiyne', and 'C2H2,vinylidene')
...
CEAGas = {
  mixtureName = 'titan-with-ions',
  speciesList = {'CH4', 'CH3', 'CH2', 'CH', 'N2', 'C2', 'H2', 
  	         'C2N2','CN', 'NH', 'HCN', 'N', 'C', 'H', 'Ar','Ar+',
		  'N2+', 'CN+', 'N+','N-','C+', 'H+', 'e-',
		  'C3','C4','C5', 'CCN', 'HNC', 
  	          'C4N2', 'CNC', 'NCN', 'C2H', 'NH+'},
  reactants = {N2=0.98,CH4=0.015,Ar=0.05},
  inputUnits = "moles",
  withIons = true,
  trace = 1.0e-6
}
