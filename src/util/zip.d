...
final class ArchiveMember
{
    ...
    @property @safe void expandedData(ubyte[] ed, size_t i)
    {
        _expandedData[i .. i + ed.length] = ed[];
        _expandedSize  = to!uint(_expandedData.length);
    ...
    /**
     * Get or set the length of the expanded data
     *
     * Params:
     *     n = requested length
     *
     * Returns: The length of the expanded file data.
     */
    @property @safe uint setExpandedDataSize(size_t n)
    {
        _expandedData.length = n;
        _expandedSize  = to!uint(_expandedData.length);
